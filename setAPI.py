...
# client = Groq(
#     api_key="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",
# )
...
#         output_file = f"classified_{os.path.splitext(csv_file)[0]}.text"
#         classified_jobs.to_csv(output_file, index=False)
